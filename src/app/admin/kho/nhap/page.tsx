    ...
    <div>
      ...
      <div className="admin-card" style={{ maxWidth: 600 }}>
        <div className="admin-form-group">
          ...
          <select className="admin-input" value={itemType} onChange={(e) => { setItemType(e.target.value as "chemicals" | "supplies"); setItemId(""); setDonVi(""); }}>
        ...
        <div className="admin-form-group">
          ...
          {selectedItem && (
            <p style={{ fontSize: 12, color: "var(--neutral-500)", marginTop: 4 }}>
              Tồn kho: <strong>{selectedItem.so_luong_ton}</strong> {selectedItem.don_vi || ""}
            </p>
          )}
        </div>
